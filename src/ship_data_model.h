...
extern "C" {
  ...
  typedef struct _adj_light {
    float intensity = 0.0;  // 0-1
    age_t age = 0U;
  } adj_light;
  ...
  typedef struct _nav_lights_t {
    ...
    struct _nav_light deck;           // These added by PACO. Attention compass
    struct _nav_light instruments;
    struct _adj_light compass;
  } nav_lights_t;
